...
import edu.bsu.petriNet.editor.EditorActions.AlignCellsAction;
import edu.bsu.petriNet.editor.EditorActions.AutosizeAction;
import edu.bsu.petriNet.editor.EditorActions.BackgroundAction;
import edu.bsu.petriNet.editor.EditorActions.BackgroundImageAction;
import edu.bsu.petriNet.editor.EditorActions.ColorAction;
import edu.bsu.petriNet.editor.EditorActions.ExitAction;
import edu.bsu.petriNet.editor.EditorActions.GridColorAction;
import edu.bsu.petriNet.editor.EditorActions.GridStyleAction;
...
import edu.bsu.petriNet.editor.EditorActions.SetLabelPositionAction;
import edu.bsu.petriNet.editor.EditorActions.SetStyleAction;
import edu.bsu.petriNet.editor.EditorActions.StyleAction;
import edu.bsu.petriNet.editor.EditorActions.StylesheetAction;
import edu.bsu.petriNet.editor.EditorActions.ToggleAction;
import edu.bsu.petriNet.editor.EditorActions.ToggleConnectModeAction;
import edu.bsu.petriNet.editor.EditorActions.ToggleCreateTargetItem;
import edu.bsu.petriNet.editor.EditorActions.ToggleDirtyAction;
import edu.bsu.petriNet.editor.EditorActions.ToggleGridItem;
import edu.bsu.petriNet.editor.EditorActions.ToggleOutlineItem;
import edu.bsu.petriNet.editor.EditorActions.TogglePropertyItem;
...
public class EditorMenuBar extends JMenuBar
{
	...
	{
		menu.add(editor.bind(mxResources.get("home"), mxGraphActions.getHomeAction(), "/edu/bsu/petriNet/images/house.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("exitGroup"), mxGraphActions.getExitGroupAction(), "/edu/bsu/petriNet/images/up.gif"));
		menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(),
				"/edu/bsu/petriNet/images/down.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/edu/bsu/petriNet/images/group.gif"));
		menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(),
				"/edu/bsu/petriNet/images/ungroup.gif"));
		...
		menu.add(editor.bind(mxResources.get("collapse"), mxGraphActions.getCollapseAction(),
				"/edu/bsu/petriNet/images/collapse.gif"));
		menu.add(editor.bind(mxResources.get("expand"), mxGraphActions.getExpandAction(), "/edu/bsu/petriNet/images/expand.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("toBack"), mxGraphActions.getToBackAction(), "/edu/bsu/petriNet/images/toback.gif"));
		menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(),
				"/edu/bsu/petriNet/images/tofront.gif"));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor)
	{
		...
		submenu.add(editor.bind(mxResources.get("fillcolor"), new ColorAction("Fillcolor", mxConstants.STYLE_FILLCOLOR),
				"/edu/bsu/petriNet/images/fillcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("fontcolor"), new ColorAction("Fontcolor", mxConstants.STYLE_FONTCOLOR),
				"/edu/bsu/petriNet/images/fontcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("linecolor"), new ColorAction("Linecolor", mxConstants.STYLE_STROKECOLOR),
				"/edu/bsu/petriNet/images/linecolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("straight"), new SetStyleAction("straight"),
				"/edu/bsu/petriNet/images/straight.gif"));

		submenu.add(editor.bind(mxResources.get("horizontal"), new SetStyleAction(""), "/edu/bsu/petriNet/images/connect.gif"));
		submenu.add(editor.bind(mxResources.get("vertical"), new SetStyleAction("vertical"),
				"/edu/bsu/petriNet/images/vertical.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction("edgeStyle=mxEdgeStyle.EntityRelation"),
				"/edu/bsu/petriNet/images/entity.gif"));
		submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction("arrow"), "/edu/bsu/petriNet/images/arrow.gif"));
		...
		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_STARTARROW, mxConstants.ARROW_OPEN),
				"/edu/bsu/petriNet/images/open_start.gif"));
		...
		submenu.add(editor.bind(mxResources.get("middle"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE),
				"/edu/bsu/petriNet/images/middle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_BOTTOM),
				"/edu/bsu/petriNet/images/bottom.gif"));
