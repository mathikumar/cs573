...
public class GraphEditor extends BasicGraphEditor
{
	...
	public GraphEditor()
	{
		this("PetriNet Editor", new CustomGraphComponent(new CustomGraph()));
	}
	...
	public GraphEditor(String appTitle, mxGraphComponent component)
	{
		...
		shapesPalette
				.addTemplate(
						...
						new ImageIcon(
								GraphEditor.class
										.getResource("/edu/bsu/petriNet/images/rectangle.png")),
						null, 35, 70, "");
		shapesPalette
				.addTemplate(
						"Place",
						new ImageIcon(
								GraphEditor.class
										.getResource("/edu/bsu/petriNet/images/ellipse.png")),
						"ellipse", 70, 70, "");
		shapesPalette
				.addEdgeTemplate(
						"Edge",
						new ImageIcon(
								GraphEditor.class
										.getResource("/edu/bsu/petriNet/images/arrow.png")),
						"arrow", 40, 40, "");
